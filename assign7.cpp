/*
TITLE: There are flight paths between cities. If there is a flight between city A and city B then there
is an edge between the cities. The cost of the edge can be the time flight take to reach city B from
A, or the amount of fuel used for this journey. Represent this as a graph. The node can be
